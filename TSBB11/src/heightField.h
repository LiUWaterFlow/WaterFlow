...
public:
	...
	GLuint fieldProgram, fieldShader, addProgram, addShader; ///< assortment of shader references
	...
	///	
	/// @param u the array of floats u is the height that will be uploaded to the GPU.
	/// @see initFloodFill
